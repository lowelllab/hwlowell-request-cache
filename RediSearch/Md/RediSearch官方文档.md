...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"create-index-with-json-schema","title":"Create index with JSON schema"},{"id":"add-json-documents","title":"Add JSON documents"},{"id":"search-the-index","title":"Search the index"},{"children":[{"id":"hash-documents","title":"Hash documents"},{"id":"json-documents","title":"JSON documents"},{"id":"making-json-documents-behave-like-hash-documents","title":"Making JSON documents behave like hash documents"},{"id":"recommended-approach-for-json","title":"Recommended approach for JSON"}],"id":"understanding-tag-field-behavior-hash-versus-json","title":"Understanding TAG field behavior: hash versus JSON"},{"children":[{"id":"approach-1-json-arrays-recommended","title":"Approach 1: JSON arrays (recommended)"},{"id":"approach-2-strings-with-explicit-separators","title":"Approach 2: strings with explicit separators"},{"id":"which-approach-to-choose","title":"Which approach to choose?"}],"id":"index-json-arrays-as-tag","title":"Index JSON arrays as TAG"},{"children":[{"id":"limitations","title":"Limitations"},{"id":"handling-phrases-in-different-array-slots","title":"Handling phrases in different array slots:"}],"id":"index-json-arrays-as-text","title":"Index JSON arrays as TEXT"},{"children":[{"id":"limitations","title":"Limitations"}],"id":"index-json-arrays-as-numeric","title":"Index JSON arrays as NUMERIC"},{"id":"index-json-arrays-as-geo-and-geoshape","title":"Index JSON arrays as GEO and GEOSHAPE"},{"id":"index-json-arrays-as-vector","title":"Index JSON arrays as VECTOR"},{"id":"index-json-objects","title":"Index JSON objects"},{"children":[{"id":"return-specific-attributes","title":"Return specific attributes"},{"id":"project-with-jsonpath","title":"Project with JSONPath"},{"id":"highlight-search-terms","title":"Highlight search terms"}],"id":"field-projection","title":"Field projection"},{"id":"aggregate-with-jsonpath","title":"Aggregate with JSONPath"},{"id":"index-missing-or-empty-values","title":"Index missing or empty values"},{"children":[{"id":"schema-mapping","title":"Schema mapping"},{"id":"jsonpath-with-multiple-values","title":"JSONPath with multiple values"}],"id":"index-limitations","title":"Index limitations"}]}
...
`attribute` is optional for [`FT.CREATE`]().
...
The preferred method for indexing multiple tag values is using JSON arrays. Each array element becomes a separate tag value. Use the [JSONPath]() wildcard operator `[*]` to index array elements.
